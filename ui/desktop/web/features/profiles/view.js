          ...
          <div class="tab-pane hidden profile-pane-plain" data-pane="dns">
            <div class="security-frame">
              <div class="grid-two">
                ...
                <label id="profile-dns-servers-row">${t("profile.field.dnsServers")}<input name="dnsServers" placeholder="1.1.9.1,8.8.8.8" value="${escapeHtml(dnsDraft?.servers ?? "")}" /></label>
  ...
  const renderDnsControls = () => {
    ...
    if (isManual) {
      ...
      if (dnsServersField && !String(dnsServersField.value ?? "").trim()) {
        dnsServersField.value = "1.1.9.1,8.8.8.8";
      }
    }
