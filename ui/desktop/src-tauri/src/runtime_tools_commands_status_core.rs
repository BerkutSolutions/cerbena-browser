...
pub(crate) fn collect_runtime_tools_status(state: &AppState) -> Result<Vec<RuntimeToolStatusView>, String> {
    ...
    let mut tools = vec![
        ...
        engine_view(state, EngineKind::FirefoxEsr)?,
...
fn engine_view(state: &AppState, engine: EngineKind) -> Result<RuntimeToolStatusView, String> {
    ...
    Ok(RuntimeToolStatusView {
        ...
        name_key: match engine {
            ...
            EngineKind::FirefoxEsr => RuntimeToolId::FirefoxEsr.name_key(),
