...
pub const SERVICE_DOMAIN_DATA: &[(&str, &[&str])] = &[
    ("4chan", &["4cdn.org", "4chan.org", "4channel.org"]),
    ("500px", &["500px.com"]),
    ("9gag", &["9gag.com"]),
    ...
    (
        "bluesky",
        &["blueskyweb.xyz", "bsky.app", "bsky.network", "bsky.social"],
    ),
    ("box", &["box.com", "boxcdn.net"]),
    ("canais_globo", &["globo.com", "globoplay.globo.com"]),
    (
        "chatgpt",
        &[
            "ai.com",
    ...
    (
        "claude",
        &["anthropic.com", "cdn.usefathom.com", "claude.ai"],
    ),
    (
        "cloudflare",
        &[
    ...
    (
        "coolapk",
        &["coolapk.com", "coolapkmarket.com", "coolapkmarket.net"],
    ),
    (
        "copilot",
        &[
    ...
    ("douban", &["douban.com", "douban.fm", "doubanio.com"]),
    (
        "dropbox",
        &[
            "db.tt",
    ...
    (
        "flickr",
        &["flic.kr", "flickr.com", "flickr.net", "staticflickr.com"],
    ),
    (
        "gemini",
        &[
    ...
    ("imgur", &["imgur.com", "imgur.io", "imgurinc.com"]),
    (
        "instagram",
        &[
            "achat-followers-instagram.com",
    ...
    ("lionsgate_plus", &["lionsgateplus.com"]),
    ("looke", &["looke.com.br"]),
    ("mail_ru", &["imgsmail.ru", "mail.ru", "mycdn.me"]),
    ("manus", &["manus.im"]),
    ...
    ("plenty_of_fish", &["pof.com"]),
    ("plex", &["plex.direct", "plex.tv"]),
    ("pluto_tv", &["pluto.tv"]),
    ("privacy", &["privacy.com"]),
    ...
    ("snapchat", &["sc-cdn.net", "snapchat.com"]),
    ("soundcloud", &["p-cdn.us", "sndcdn.com", "soundcloud.com"]),
    (
        "spotify",
        &[
    ...
    ("tinder", &["tinder.com"]),
    ("tumblr", &["tmblr.co", "tumblr.co", "tumblr.com"]),
    (
        "twitch",
        &[
            "ext-twitch.tv",
    ...
    ("ubisoft", &["ubisoft.com", "uplaypc-s-ubisoft.cdn.ubi.com"]),
    ("valorant", &["playvalorant.com", "valorant.com"]),
    ("viber", &["viber.com"]),
    (
        "vimeo",
        &[
    ...
    ("weibo", &["weibo.cn", "weibo.com", "weibocdn.com"]),
    (
        "whatsapp",
        &[
            "bintray.com",
